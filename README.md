...
Cada notebook possui o **código** (`.ipynb` no repositório) e a **execução com saídas** (`.html` via GitHub Pages). Índice completo: [docs/notebooks](docs/notebooks/README.md).
